...
document.getElementById('sendButton').addEventListener('click', function () {
    ...
    var telegramURL = 'https://t.me/Husan_607?text=Name: %20' + encodeURIComponent(name) +
        '%0AEmail: %20' + encodeURIComponent(email) +
        '%0ASubject: %20' + encodeURIComponent(subject) +
...
// contact tell
document.querySelector('.contact-item-inner').addEventListener('click', function () {
    window.location.href = 'tel:+998883337011';
});
